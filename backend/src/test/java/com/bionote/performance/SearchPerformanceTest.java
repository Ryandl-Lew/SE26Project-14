...
class SearchPerformanceTest {
    ...
    private static final String TEST_PROJECT_CODE = "PRJ2026070001";
    ...
    void setUp() {
        ...
        projectId = jdbcTemplate.queryForObject(
                "SELECT id FROM projects WHERE code = ?", String.class, TEST_PROJECT_CODE);

        TestSecurityContextHolder.setAuthentication(
                new UsernamePasswordAuthenticationToken(
                        new UserPrincipal(ownerId, "li", "李同学"), null, List.of()));
